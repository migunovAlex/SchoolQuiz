...
INSERT INTO `adminusers` VALUES (3,'RootAdmin','717765727479414d314a61636b736f6e4a61636b736f6e'),(4,'admin','6e696d64614a61636b736f6e4a61636b736f6e');
UNLOCK TABLES;
...
DROP TABLE IF EXISTS `adminusersession`;
CREATE TABLE `adminusersession` (
  ...
  PRIMARY KEY (`ID`),
  KEY `adminusersession_ibfk_1` (`ADMIN_USER`),
  CONSTRAINT `adminusersession_ibfk_1` FOREIGN KEY (`ADMIN_USER`) REFERENCES `adminusers` (`ID`)
...
/*!40000 ALTER TABLE `adminusersession` DISABLE KEYS */;
LOCK TABLES `adminusersession` WRITE;
INSERT INTO `adminusersession` VALUES (1,4,'5V98XWLHEH1U60N3U643',1357225479806,0),(2,4,'W1WA5ZYG395HB4TAO5Q5',1357226475767,0),(3,4,'LHY61TO2JH112P8HJ9S7',1357226513758,0),(4,4,'T1L847X5D1981CG93UX2',1357226619285,0),(5,4,'1B5JDAP981OA3770A0W7',1357227094575,0),(6,4,'M0J300BS1H9UIDW8O2GR',1357228439866,0),(7,4,'WYKJX9ERK1VEHI4P7O42',1357228471581,0),(8,4,'T4IR717GFJAF3S6CWX0P',1357228484226,0),(9,4,'782P8PDN00YFB793805R',1357294947013,0),(10,4,'VXS8O5CM5V7192627P11',1357295661392,0),(11,4,'X9S667W10ST252V430B0',1357295669056,0),(12,4,'M2900VE07ZCYE7767WUB',1357295757600,0),(13,4,'D1YACSBU0YBS0441NJ30',1357295869704,0),(14,4,'B1477575JG30B11RXALR',1357295878135,0),(15,4,'700IC7X0316699M4S57C',1357295975754,0),(16,4,'038T7RX048BJ57X302GY',1357296041900,0),(17,4,'8Y2GOCR6FNJQ300XI055',1357300435517,0),(18,4,'0ANR5LT39R4N5TX81LOU',1357300789551,0),(19,4,'9099442QS75UFM75EOI4',1357300817611,0),(20,4,'F7ZYEZJUW7L3T0791SVR',1357300819760,0),(21,4,'O4FL1GX52GA3M1O7458H',1357300820997,0),(22,4,'ORRP659F0KDWF7W9U6W4',1357300839275,0),(23,4,'00823BNVJ5P3YQY93CCP',1357303849017,0),(24,4,'4U18VD5D5S4B69A6J16P',1357303870313,0),(25,4,'9I392T7TFWV17A19EN7V',1357304246944,0),(26,4,'9R84M34H4576LG33DE3R',1357307423185,0),(27,4,'C3Y4525LSAJ30754I71I',1357309309776,0),(28,4,'3YW0GY3MZJU82T60PD04',1357315667638,1);
UNLOCK TABLES;
/*!40000 ALTER TABLE `adminusersession` ENABLE KEYS */;
...
INSERT INTO `useranswers` VALUES (1,14,1,18),(2,14,5,25),(3,14,5,26),(4,14,5,27),(5,14,5,28),(6,14,4,25),(7,14,4,26),(8,14,4,27),(9,14,4,25),(10,14,4,26),(11,14,4,27),(12,15,6,21),(13,15,6,23),(14,15,4,25),(15,15,4,26),(16,15,4,25),(17,15,4,26),(18,15,4,27),(19,15,4,25),(20,15,4,26),(21,15,4,27),(22,15,4,25),(23,15,4,26),(24,15,4,27),(25,15,4,25),(26,15,4,26),(27,15,4,27),(28,29,1,16),(29,29,2,21),(30,29,4,25),(31,29,4,26),(32,29,4,27),(33,29,6,23),(34,29,7,24);
UNLOCK TABLES;
